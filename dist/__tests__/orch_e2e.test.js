...
describe('Orchestrator E2E Tests', () => {
    ...
    describe('Health Check', () => {
        it('should return healthy status from orchestrator health endpoint', async () => {
            const response = await axios_1.default.get(`${BASE_URL}${ORCH_BASE_PATH}/health`, {
                headers: {
    ...
    describe('Happy Path - Round Sequence', () => {
        it('should execute full round sequence via probe endpoint', async () => {
            ...
            const response = await axios_1.default.post(`${BASE_URL}${ORCH_BASE_PATH}/probe/round`, {
            ...
            const steps = results.sequence.map((s) => s.step);
    ...
    describe('Idempotency', () => {
        it('should return identical response for same idempotency key', async () => {
            ...
            // First request
            const response1 = await axios_1.default.post(`${BASE_URL}${ORCH_BASE_PATH}/probe/round`, payload, {
                headers: {
            ...
            const response2 = await axios_1.default.post(`${BASE_URL}${ORCH_BASE_PATH}/probe/round`, payload, {
                headers: {
                    'X-Correlation-Id': (0, uuid_1.v4)(), // Different correlation ID
    ...
    describe('Failure Modes', () => {
        ...
        it('should handle insufficient funds properly', async () => {
            ...
            if (response.status === 200) {
                const debitStep = response.data.results.sequence.find((s) => s.step === 'debit');
    ...
    describe('Correlation ID Propagation', () => {
        it('should propagate correlation ID through all calls', async () => {
            const testCorrelationId = (0, uuid_1.v4)();
            const response = await axios_1.default.post(`${BASE_URL}${ORCH_BASE_PATH}/probe/round`, {
...
//# sourceMappingURL=orch_e2e.test.js.map